#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from evaluation.affiliation.generics import (
        infer_Trange,
        has_point_anomalies, 
        _len_wo_nan, 
        _sum_wo_nan,
        read_all_as_events)
from evaluation.affiliation._affiliation_zone import (
        get_all_E_gt_func, 
        affiliation_partition)
from evaluation.affiliation._single_ground_truth_event import (

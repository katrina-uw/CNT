...
from task_utils.evaluation.vus.utils.metrics import metricor
from task_utils.evaluation.vus.utils.metrics_faster import RangeAUC_volume_faster
...
def generate_curve(label,score,slidingWindow):
    tpr_3d, fpr_3d, prec_3d, window_3d, avg_auc_3d, avg_ap_3d = RangeAUC_volume_faster(labels_original=label, score=score, windowSize=1*slidingWindow)
